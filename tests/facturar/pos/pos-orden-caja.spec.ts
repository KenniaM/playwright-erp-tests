...
test.beforeEach(async ({ pos }) => {
  ...
  // fuerza la base una vez por test antes de cualquier assert de montos. No
  // reemplaza el manejo propio de "Orden de Caja — Moneda contraria a la
  // base" (ese describe cambia y restaura la moneda deliberadamente dentro
  // de su propio test).
