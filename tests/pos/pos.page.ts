...
// Paso 0 de la migración a composición (ver el plan aprobado en
...
// pasos del plan: extraer cada dominio (Cierre de Caja, Navegación,
// Proforma, Crear Producto, Importar Factura, Orden de Caja, Apartado,
// Ruteo) a su propia clase, y convertir PosPage en una fachada que delega a
// instancias de esas clases por composición.
