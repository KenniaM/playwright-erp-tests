...
export const SUBMODULOS_REPORTES_INVENTARIO: SubmoduloReportes[] = [
  {
    nombre: 'Inventario',
    url: BASE_URL + '/reports/productReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productGeneralQuantityReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/inventory_turnover_rate',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productsCatalog',
  ...
  {
    nombre: 'Apartados',
    url: BASE_URL + '/reports/layawayReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productMovementReportSearch',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/best_selling_products',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/externalProductReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/products_details_sales',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productsToOrder',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productBySizeReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/productsToExpire',
