...
import { ReportesPage, SUBMODULOS_REPORTES_RIFAS, TIMEOUTS } from './reportes.page';

for (const submodulo of SUBMODULOS_REPORTES_RIFAS) {
  test(`Cargar el submódulo "${submodulo.nombre}" del módulo Reportes > Rifas`, async ({ page }) => {
