...
export const SUBMODULOS_REPORTES_VENTAS: SubmoduloReportes[] = [
  {
    nombre: 'Ventas',
    url: BASE_URL + '/reports/salesReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/salesByProductReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/sales_by_seller_tire_report',
  ...
  {
    nombre: 'Utilidad',
    url: BASE_URL + '/reports/utilityReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/receivableListReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/accounts_receivable',
  ...
  },
  {
    ...
    url: BASE_URL + '/credit_customer_history/creditCustomerHistoryIndex',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/seniority_of_credit',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/salesPerSellerReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/salesReportQuickProduct',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/agentSalesReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/credit_sales_commissions_report',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/clientSalesReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/creditNoteReport',
  ...
  },
  {
    ...
    url: BASE_URL + '/reports/getOnlineStoreSalesReport',
...
const URL_COMISIONES_PRODUCTO = BASE_URL + '/reports/productCommissionReport';
